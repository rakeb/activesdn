...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "activesdn";
    private final String namespace = "urn:sdnhub:tutorial:odl:activesdn";
    private final String revision = "2015-06-01";
    private final String resourcePath = "/META-INF/yang/activesdn.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.sdnhub.tutorial.odl.tap.rev150601.$YangModuleInfoImpl.getInstance());
