...
public class TapBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.sdnhub.tutorial.odl.tap.rev150601.tap.spec.Tap> {
    ...
    public TapBuilder(org.opendaylight.yang.gen.v1.urn.sdnhub.tutorial.odl.tap.rev150601.EventActions arg) {
    ...
    */
    ...
    public TapBuilder setCount(final java.lang.Long value) {
    if (value != null) {
    ...
    public TapBuilder setDstIpAddress(final LocalIpv4Prefix value) {
        this._dstIpAddress = value;
        return this;
    }
    
     
    public TapBuilder setDstMacAddress(final MacAddress value) {
    ...
    public TapBuilder setDuration(final java.lang.Long value) {
    if (value != null) {
    ...
    public TapBuilder setInPortConnector(final NodeConnectorId value) {
    ...
    public TapBuilder setSourceIpAddress(final LocalIpv4Prefix value) {
        this._sourceIpAddress = value;
        return this;
    }
    
     
    public TapBuilder setSourceMacAddress(final MacAddress value) {
        this._sourceMacAddress = value;
        return this;
    }
    
     
    public TapBuilder setTapActions(final TapActions value) {
