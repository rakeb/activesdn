...
class MyTopo( Topo ):
	...
	self.addLink( host12, switch3)
        ...
        self.addLink( switch1, switch4,  use_htb=True)# delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch2, switch4,  use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch3, switch4,  use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch4, switch5, bw=0.5, max_queue_size=100, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
