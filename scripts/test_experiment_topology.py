...
class MyTopo( Topo ):
	...
	self.addLink( host12, switch11)
        ...
        self.addLink( switch6, switch4, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch6, switch5, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch7, switch4, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch7, switch5, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)

        self.addLink( switch4, switch1, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch4, switch2, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch4, switch3, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)

        self.addLink( switch5, switch1, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch5, switch2, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch5, switch3, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)

        self.addLink( switch10, switch8, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms', loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch10, switch9, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms', loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch11, switch8, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms', loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch11, switch9, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms', loss=1, max_queue_size=10, use_htb=True)

        self.addLink( switch8, switch1, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch8, switch2, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch8, switch3, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)

        self.addLink( switch9, switch1, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
	self.addLink( switch9, switch2, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
        self.addLink( switch9, switch3, max_queue_size=10, loss=5, use_htb=True)#bw=10, delay='5ms',  loss=1, max_queue_size=10, use_htb=True)
'''
