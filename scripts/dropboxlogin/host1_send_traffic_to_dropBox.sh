#!/bin/bash
xterm -fg red -bg black -fa 'Monospace' -fs 12 -geometry 70x30+600+10 -e "echo 'H1 sending traffic to DropBox H10 in port 100'; 
sudo python generate_dropbox_traffic.py 10.0.0.1 10.0.0.10 1;
sleep 1000;"
